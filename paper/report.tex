...
\begin{table}[h]
  ...
  \scalebox{0.8}{
    \begin{tabular}{|l|r|r|r|r|}
        \hline
        \multicolumn{1}{|c|}{Real-world} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{\# induced}\\
...
\begin{table}[h]
  ...
  \scalebox{0.8}{
    \begin{tabular}{|l|r|r|r|r|r|r|r|}
        ...
        \hline
        Database & 0.034 & 0.03 & 0.019 & 0.019 & 0.015 & 0.021 & 0.026\\
        CondMat & 0.039 & 0.039 & 0.033 & 0.026 & 0.024 & 0.028 & 0.03\\
        Marvel & 4.034 & 2.034 & 1.055 & 0.592 & 0.34 & 0.231 & 0.236\\
        DBLP & 11.054 & 8.041 & 5.692 & 4.06 & 3.01 & 2.815 & 2.79\\
        Github & 662.976 & 334.258 & 168.153 & 90.041 & 46.005 & 26.653 & 19.619\\
        Kindle & 1191.062 & 605.218 & 309.911 & 168.394 & 86.568 & 50.424 & 35.445\\
        IMDB & 1222.31 & 616.419 & 317.124 & 170.187 & 87.783 & 50.025 & 35.404\\
        \hline
    \end{tabular}
  }
  \vspace{0.5cm}
...
All experiments were performed on a Linux operating system running on a machine with Intel Xeon Gold processor at 2.1 GHz.
We ran our algorithm on 4 sockets with each having 13 cores for a total of 52 cores.
...
In terms of runtime in relation to the number of cores, Github, Kindle, and IMDB had significant speedups of about 34x when comparing 52 cores to a single core.
There also isn't a significant decline in expected improvement when using 52 cores for these graphs, suggesting that additional cores may be used to significantly speedup the algorithm.
...
Marvel's large induced 6-cycle count compared to its graph size indicates a dense induced 6-cycle structure, which results in significant speedups from this duplicate processing avoidance.
DBLP has a low induced 6-cycle count compared to its graph size, which indicates a sparse induced 6-cycle structure.
Since fewer induced 6-cycles are processed, DBLP has a faster runtime than Github, Kindle, and IMDB even though it is a larger graph.
...
Parallel induced 6-cycle counting is implemented in \textit{6CycleCount.cpp}.
